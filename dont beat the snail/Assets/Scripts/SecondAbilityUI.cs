...
public class SecondAbilityUI : MonoBehaviour
{
    ...
    void Update()
    {
        overlay.fillAmount = (float)abilityController.abilities[1].cooldownTimer / (abilityController.abilities[1].Cooldown * 50);
    }

    public void Switch()
    {
        ability.SetTrigger(abilityController.abilities[1].animationName);
